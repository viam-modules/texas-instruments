...
// Voltage LSB: 4 mV for INA219
// Current LSB: maximum expected current of the system / (1 << 15)
// Power LSB: 20*CurrentLSB for INA219
...
var (
	...
	// Model219 for viam supported texas-instruments ina219 power sensor.
	Model219 = resource.NewModel("viam", "texas-instruments", "ina219")
)
